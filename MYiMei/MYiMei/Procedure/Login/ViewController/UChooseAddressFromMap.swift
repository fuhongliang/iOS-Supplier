...
class UChooseAddressFromMap: UBaseViewController, MAMapViewDelegate, PlaceAroundTableViewDeleagate {

    var search: AMapSearchAPI!
    var mapView: MAMapView!

    var tableView: UPlaceAroundTableView!
    ...
    func initMapView() {
        mapView = MAMapView(frame: CGRect(x: 0, y: 0, width: self.view.bounds.width, height: screenHeight / 2.0))
