//
//  UOrdersCompleteController.swift
//  MYiMei
//
...
class UOrdersCompleteController: UBaseViewController {
    ...
    lazy var tableView: UITableView = {
        ...
        tw.register(cellType: UOrderCompleteCell.self)
        return tw
    }()
...
extension UOrdersCompleteController: UITableViewDelegate, UITableViewDataSource {
...
extension UOrdersCompleteController : JXSegmentedListContainerViewListDelegate {
