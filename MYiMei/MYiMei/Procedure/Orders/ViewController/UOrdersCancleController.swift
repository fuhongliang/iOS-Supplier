...
class UOrdersCancleController : UBaseViewController {
...
extension UOrdersCancleController : UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCell(for: indexPath, cellType: UOrderCancleCell.self)
...
extension UOrdersCancleController  : JXSegmentedListContainerViewListDelegate {
