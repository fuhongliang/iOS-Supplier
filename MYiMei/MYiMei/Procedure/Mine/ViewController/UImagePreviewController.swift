...
class UImagePreviewController: UBaseViewController {
    //存储图片数组
    var images:[String]
    ...
    //初始化
    init(images:[String],isUrlImg:Bool = false, index:Int = 0){
        self.images = images
        self.isUrlImg = isUrlImg
        self.index = index
...
//        self.view.backgroundColor = UIColor.clear
        ...
        collectionView.backgroundColor = UIColor.init(red: 0, green: 0, blue: 0, alpha: 0.5)
...
extension UImagePreviewController:UICollectionViewDelegate, UICollectionViewDataSource,UICollectionViewDelegateFlowLayout{
